      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button onClick={onAccountClick} className="p-2 text-gray-600 hover:text-orange-500 transition-colors">
          ...
          <div className="md:hidden pb-4">
            <div className="flex items-center justify-around">
              ...
              >
               ...
               <button onClick={onAccountClick} className="flex flex-col items-center p-2 text-gray-600 hover:text-orange-500 transition-colors">
                 <User className="h-6 w-6" />
